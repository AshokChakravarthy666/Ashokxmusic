...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("https://t.me/+HMHH1y96Sz1jMmVl")
                await self.one.join_chat("https://t.me/+ITKJ6qtpM0hiOGU9")
                await self.one.join_chat("https://t.me/+5adkfK7wdAswMjNl")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("https://t.me/+HMHH1y96Sz1jMmVl")
                await self.two.join_chat("https://t.me/+ITKJ6qtpM0hiOGU9")
                await self.two.join_chat("https://t.me/+5adkfK7wdAswMjNl")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("https://t.me/+HMHH1y96Sz1jMmVl")
                await self.three.join_chat("https://t.me/+ITKJ6qtpM0hiOGU9")
                await self.three.join_chat("https://t.me/+5adkfK7wdAswMjNl")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("https://t.me/+HMHH1y96Sz1jMmVl")
                await self.four.join_chat("https://t.me/+ITKJ6qtpM0hiOGU9")
                await self.four.join_chat("https://t.me/+5adkfK7wdAswMjNl")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("https://t.me/+HMHH1y96Sz1jMmVl")
                await self.five.join_chat("https://t.me/+ITKJ6qtpM0hiOGU9")
                await self.five.join_chat("https://t.me/+5adkfK7wdAswMjNl")
