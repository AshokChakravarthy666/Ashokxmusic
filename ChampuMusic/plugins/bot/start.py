...
"""
        ...
        try:
            ...
            champu = await message.reply_text(f"**𝙰𝚂𝙷𝙾𝙺𝚇𝙶𝙷𝙾𝚂𝚃❣️.....**")
            await champu.edit_text(f"**𝙰𝚂𝙷𝙾𝙺❣️....**")
            await champu.edit_text(f"**𝚇❣️...**")
            await champu.edit_text(f"**𝙶𝙷𝙾𝚂𝚃❣️..**")
            await champu.edit_text(f"**𝙰𝚂𝙷𝙾𝙺𝚇𝙶𝙷𝙾𝚂𝚃❣️.**")
