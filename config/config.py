...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AshokChakravarthy666/Ashokxmusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/+HMHH1y96Sz1jMmVl"
)  # Example:- https://t.me/akaChampu
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/+ITKJ6qtpM0hiOGU9"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/AshokChakravarthy666")
...
PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "https://envs.sh/pBB.jpg",
)

GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "https://envs.sh/pBS.jpg",
)
...
TELEGRAM_AUDIO_URL = getenv(
    "TELEGRAM_AUDIO_URL",
    "https://envs.sh/pBj.jpg",
)

TELEGRAM_VIDEO_URL = getenv(
    "TELEGRAM_VIDEO_URL",
    "https://envs.sh/pBn.jpg",
)

STREAM_IMG_URL = getenv(
    "STREAM_IMG_URL",
    "https://envs.sh/pBW.jpg",
)

SOUNCLOUD_IMG_URL = getenv(
    "SOUNCLOUD_IMG_URL",
    "https://envs.sh/pBp.jpg",
)

YOUTUBE_IMG_URL = getenv(
    "YOUTUBE_IMG_URL",
    "https://envs.sh/pBA.jpg",
)

SPOTIFY_ARTIST_IMG_URL = getenv(
    "SPOTIFY_ARTIST_IMG_URL",
    "https://envs.sh/pB_.jpg",
)

SPOTIFY_ALBUM_IMG_URL = getenv(
    "SPOTIFY_ALBUM_IMG_URL",
    "https://graph.org/file/90c6c02debf04481b983d.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://envs.sh/pws.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://envs.sh/pBB.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://envs.sh/pBS.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://envs.sh/pBS.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://envs.sh/pBj.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://envs.sh/pBW.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://envs.sh/pBp.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://envs.sh/pBA.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://envs.sh/pBn.jpg":
